...
import task1_object_model.planes.AirlineCompany;
import task1_object_model.planes.Airliner;
import task1_object_model.planes.FreightAircraft;
import task1_object_model.planes.Plane;
...
public class Application {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("Total passenger aircrafts capacity " + sumCapacity + " passengers.");
		System.out.println("Total freight aircrafts capacity " + sumFreight + " tons.");
		System.out.println(
				"-----------------------------------------------------------------------------------------------------------");

		//////////////////////////////////////////////////////////////////////////////
		System.out.println("Sorted by flying range:");
